...
public class SurveyResourceTest {
    ...
    void addNewSurveyQuestion_basicScenario() throws Exception {
        ...
        // Creating a request builder for post -> posting to url -> response in json format
        // -> sending content as resquestBody -> content is in JSON format
        RequestBuilder requestBuilder =
                MockMvcRequestBuilders.post(ALL_QUESTIONS_URL).accept(MediaType.APPLICATION_JSON)
    ...
    void retrieveAllSurveyQuestions_basicScenario() throws Exception {
        RequestBuilder requestBuilder =
                MockMvcRequestBuilders.get(ALL_QUESTIONS_URL).accept(MediaType.APPLICATION_JSON);
